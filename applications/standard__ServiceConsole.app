...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <tabs>Supplies_Order_Line__c</tabs>
    <tabs>Affilation__c</tabs>
    <tabs>Form__c</tabs>
    <tabs>Offsite_Phlebotomy_Service__c</tabs>
    <workspaceConfig>
        <mappings>
            <tab>Affilation__c</tab>
        </mappings>
        <mappings>
            <tab>Form__c</tab>
        </mappings>
        <mappings>
            <tab>Guardant_360_Sample__c</tab>
        </mappings>
        <mappings>
            <tab>Offsite_Phlebotomy_Service__c</tab>
        </mappings>
        <mappings>
            <tab>Supplies_Order_Line__c</tab>
        </mappings>
        <mappings>
